...
/**
 * Widget de sélection des utilisateurs pour un concepteur agence (select2).
 */
class UtilisateurConcepteurAgenceSelectType extends EntityType
{
    /**
        ...
        $resolver->setDefaults(
            [
                ...
                'query_builder' => function (EntityRepository $entityRepository) {
                    ...
                    return $entityRepository->selectAllByRole(Role::CONCEPTEUR_AGENCE);
                },
